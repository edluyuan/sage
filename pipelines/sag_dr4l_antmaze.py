    ...
    if args.mode == "inference":
        ...
        if use_jepa_gate:
            gate = SJEPAGate(
                ...
                encoder_ckpt=getattr(args, 'sj_encoder_ckpt', 'jepa/results/d4rl/antmaze-medium-play-v2/seed42/encoder_ema.pt'),
                ac_ckpt=getattr(args, 'sj_ac_ckpt', 'jepa/results-ac/d4rl/antmaze-medium-play-v2/seed42/ac_predictor_final.pt'),
            ...
            gate_cfg = GatingConfig(
                ...
                lambda_pen=float(getattr(args, 'gate_lambda_pen', 0.00)),
