...
def pipeline(args):
    ...
    sage = SAGEEnergyScorer(
        ...
        # Kitchen actions from diffusion policy are already in [-1,1]; don't squash again
        ...
        # planner operates in normalized state space => unnormalize before JEPA stats (matches your MuJoCo/Maze2D bridge)
