...
PY=${PY:-python}
MAIN=${MAIN:-pipelines/sage_d4rl_antmaze.py}
...
# ------------------ run spec ------------------
SEED=${SEED:-42}
ENV_ID=${ENV_ID:-antmaze-medium-play-v2}   # e.g. / antmaze-medium-play-v2 / antmaze-large-diverse-v2
...
# AntMaze: actions from diffusion policy are already in [-1,1], so typically False
